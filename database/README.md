...
| **areas** | Flat project areas (ordered list) | FK: project_id |
...
- **areas:** Unique `code` per project; ordered by `sort_order`
...
Optimized for: project list by status, search by name, area list ordering, audit queries by entity/timestamp.
